...
//        NoArgFunction<NoArgFunction<String>> createGreeting= () ->{
//            return () -> "Hello world! from function";
//        };

        /**
         * or you can remove the curle bases {}
         * () function return another function () that return string
         */
        NoArgFunction<NoArgFunction<String>> createGreeting= () ->() -> "Hello world! from function";
        NoArgFunction<String> greeter=createGreeting.apply();
        ...
        System.out.println(timesThree.apply(8));
        System.out.println(timesFour.apply(9));
